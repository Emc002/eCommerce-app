...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <!-- CSS -->
        <link href="{{ asset('storage/css/black-dashboard.css?v=1.0.0') }}" rel="stylesheet" />
        <link href="{{ asset('storage/css/theme.css') }}" rel="stylesheet" />
    </head>
    <body class="{{ $class ?? '' }}">
        @auth()
            <div class="wrapper">
                    @include('admin.layoutsAdmin.navbars.sidebar')
                <div class="main-panel">
                    @include('admin.layoutsAdmin.navbars.navbar')
        ...
        <script src="{{ asset('storage/js/core/jquery.min.js') }}"></script>
        <script src="{{ asset('storage/js/core/popper.min.js') }}"></script>
        <script src="{{ asset('storage/js/core/bootstrap.min.js') }}"></script>
        <script src="{{ asset('storage/js/plugins/perfect-scrollbar.jquery.min.js') }}"></script>
        <!--  Google Maps Plugin    -->
        ...
        <script src="{{ asset('storage/js/plugins/bootstrap-notify.js') }}"></script>

        <script src="{{ asset('storage/js/black-dashboard.min.js?v=1.0.0') }}"></script>
